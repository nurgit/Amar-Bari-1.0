              ...
              @if (count($houses)>0)
                ...
                @if ($house->dlt==1)
                  <div class="card text-capitalize mr-4 mr-xl-5 mb-sm-4 mb-4">
                    ...
                    <button class="edit text-capitalize" data-toggle="modal" data-target="#acc-edit-modal-{{$house->id}}">
                      edit
                    ...
                    <div
                      class="delete-con"
                      data-toggle="modal"
                      data-target="#del-modal-{{$house->id}}"
                    ></div>
                    <svg
                    width="14"
                    height="19"
...
{{-- add building --}}
      <div class="modal fade" id="acc-add-modal">
        <div class="modal-dialog">
          <div class="modal-content add-modal-content">
            <div class="modal-body">
              <form action="{{route('addBuilding')}}" method="POST" class="row form mb-2 mb-md-4" >
                @csrf
                ...
                <div class="col-sm-12 col-lg-4 half-input input-con">
                  <input
                    type="text"
                    name="holding_no"
                    id=" acc-input"
                    ...
                    required
                  />
                  <label for="acc-input" class="label">holding no</label>
                </div>
                ...
                <div class="col-sm-12 col-lg-4 half-input input-con">
                  <input
                    ...
                    required
                  />
                  <label for="acc-input" class="label">road_no</label>
                </div>
                ...
                <div class="col-sm-12 col-lg-4 half-input input-con">
                  <input
                    ...
                    required
                  />
                  <label for="acc-input" class="label"> city</label>
                </div>
    ...
    {{-- Edit building --}}
      ...
      <div class="modal fade" id="acc-edit-modal-{{$house->id}}">
        <div class="modal-dialog">
          <div class="modal-content add-modal-content">
            <div class="modal-body">
              <form action="{{route('building.update',$house->id)}}" method="POST" enctype="multipart/form-data" class="row form mb-2 mb-md-4" >
                @csrf
                <div class="col-12 input-con">
                  <input
                    type="text"
                ...
                <div class="col-sm-12 col-lg-4 half-input input-con">
                  <input
                    ...
                    required
                  />
                  <label for="acc-input" class="label">Rode No</label>
                </div>
 ...
 <!--===============  delete modal ===============  -->
      ...
      <div class="modal fade" id="del-modal-{{$house->id}}">
        <div class="modal-dialog">
          <div class="modal-content del-modal-content">
            <div class="modal-body">
              <p class="del-warning">
               
                <br>Building Name: {{$house->name}} <br> Building Holding No: {{$house->holding_no}} <br>
                You’re about to delete this building. Do you want to continue?
              </p>
