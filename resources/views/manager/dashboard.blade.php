  ...
  <div class="first-row col-12">
    ...
    {{-- <div class="second-row cards row">
      <div class="month-column  mb-sm-5 mb-5">
        ...
        <div class="info-container text-capitalize">
          <div class="box">
            <div class="box-label ">bild no.</div>
            <div class="box-content">b01</div>
          </div>
          ...
          <div class="box paid payment-box">
            <div class="box-label">paid</div>
            <div class="box-content">7000</div>
          </div>

          <div class="box due payment-box">
            <div class="box-label">due</div>
            <div class="box-content">3000</div>
          </div>
        </div>
      </div>

      <div class="year-column mb-sm-5 mb-5">
        <p class="caption text-capitalize col-12">this year</p>
    ...
    <form action="" class="row form mb-2 mb-md-4">
      ...
      <div class="col-sm-12 col-lg-6 input-con half-input">
        <input
          ...
          required
        />
        <label for="acc-input" class="label text-uppercase">nid</label>
      </div>
...
<div class="modal-content del-modal-content">
  <div class="modal-body">
    <p class="del-warning">
      You’re about to delete this account. Do you want to continue?
    </p>
