...
<html lang="en">
  <head>
    ...
    <title>Flats</title>
    <link rel="icon" href="./icon/brand.svg" />
      ...
      <div class="left dashboard">
        ...
        <div class="link-wrapper">
          ...
          <a href="building.html" class="link ">
            <div class="svg-bg">
              <img src="./icon/Buildings.svg" alt="" />
            </div>

            <span> buildings</span>
          </a>

          <a href="flats.html" class="link active">
            <div class="svg-bg">
              <img src="./icon/Flats-active.svg" alt="" />
            </div>
        ...
        <img src="./icon/logout.svg" class="log-icon" alt="">
        </a>
        <div class="credit">
          Powered By
          <a
        ...
        <div class="top-bar">
          <div class="bar-content">
            ...
            <div class="dropdown">
              ...
              >
                <a>
                <img src="./icon/Uk Flag.svg" alt="" class="uk-flag" >

                  english

                 <img src="./icon/dropdown.svg" alt=""  class="down-arrow">
                </a>
              </button>
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item text-capitalize" href="#">
                <img src="./icon/BD Flag.svg" alt="" class="bd-flag">
            ...
            <a href="index.html" class="btn-log"
              >logout

              <img src="./icon/logout.svg" alt="" class="log-icon"  >
            </a>
          </div>
        </div>
        <!--              top bar              -->
          ...
          <div class="first-row col-12">
            ...
            <div class="card text-capitalize mr-4 mr-xl-5 mb-sm-4 mb-4">
                <div class="top-section">
                  <h1 class="flat-no">a101</h1>
                  <p class="rent">rent: 10000</p>
                </div>

                <div class="mid-section">
                  <p class="size">size: 700sqft</p>
                  <p class="name">adnan</p>
                ...
                <button class="edit text-capitalize" data-toggle="modal" data-target="#acc-modal">
                  edit
                  <img src="./icon/edit-pen.svg" alt="">
                </button>
                </div>

                <img src="./icon/Flat 3D.svg" alt="" class="card-building">
              ...
              <div class="add mr-4 mr-xl-5 mb-sm-5 mb-4">
                ...
                <img src="./icon/Union.svg" alt=""class="add-icon">
                </div>
              </div>
            </div>
          </div>
            ...
            <form action="" class="row form mb-2 mb-md-4">
              ...
              <div class="col-12 col-lg-6 half-input input-con">
                <input
                  ...
                  required
                />
                <label for="acc-input" class="label">tenant's name</label>
              </div>
