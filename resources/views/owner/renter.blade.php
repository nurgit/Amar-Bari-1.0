...
@foreach ($houses as $house)
<div class="modal fade" id="add-{{$house->id}}">
      ...
      <div class="modal-body">
        ...
        <form  action="{{route('renter.addrenter')}}"  method="POST" class="row form mb-2 mb-md-4">
          ...
          <div class="col-12 col-lg-6 half-input input-con">
            ...
            <select id="inputState" class="form-input" name="flat_id">
              
              <option selected value="">Please Choose your flat from  House: {{$house->name}} ...</option>
              @foreach ($flats as $flat)
                 @if ($flat->house_id==$house->id)
...
{{-- Update  Renter ------------------------------ --}}
    @foreach ($renters as $renter)
    <div class="modal fade" id="update-modal-{{$renter->id}}">
      <div class="modal-dialog">
        <div class="modal-content add-modal-content"> 
          <div class="modal-body">
...
<!--===============  delete modal ===============  -->
@foreach ($renters as $renter)
<div class="modal fade" id="del-modal-{{$renter->id}}">
  <div class="modal-dialog">
