...
<div class="card-section row">
  <div class="first-row col-12">
      <p class="caption text-capitalize col-12">Accout Information</p>
      <p  style="width: 60%;" > @if (Session::get('success'))
        <div class="alert alert-success">
          {{Session::get('success')}}
        </div>
        @endif

        @if (Session::get('faill'))
      ...
      <div class="cards row">
        @if (count($owners)>0)
          @foreach ($owners as $owner)
            ...
            <p class="id">id: {{$owner->id}}</p>

            <p class="location">{{$owner->address}}</p>

            <p class="number">{{$owner->phone}}</p>

            <button class="edit text-capitalize" data-toggle="modal" data-target="#owner-modal-edit-{{$owner->id}}">
              edit
...
<!--===============  Manager edit modal ===============  -->
    ...
    {{-- Owner edit  --}}
    @foreach ($owners as $owner)
    <div class="modal fade" id="owner-modal-edit-{{$owner->id}}">
      <div class="modal-dialog">
        <div class="modal-content add-modal-content">
          <div class="modal-body">
            <form  action="{{route('account.owner.edit',$owner->id)}}" method="POST" class="row form mb-2 mb-md-4">
              @csrf
              <div class="col-12 input-con" >
                <input
                  type="text"
              ...
              <div class="col-sm-12 col-lg-6 input-con half-input" >
                <input
                  ...
                  readonly
                />
                <label for="acc-input" class="label text-uppercase">User Nme</label>
              </div>
              <div class="col-sm-12 col-lg-6 input-con half-input" >
                <input
                  type="text"
