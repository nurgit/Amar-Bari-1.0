...
@section('content')
        ...
        <div class="tab-bar">
          <div class="tab-container">
              ...
              <div class="tab-btn text-uppercase tab-btn-active" data-target="tab1">bo1</div>
              <div class="tab-btn text-uppercase" data-target="tab2">bo2</div>
              <div class="tab-btn text-uppercase" data-target="tab3">bo3</div>
...
<div class="card-section row">
    <div class="first-row col-12">
      ...
      <div class="cards row active-tab" id="tab1">
        @if (count($flats)>0)
